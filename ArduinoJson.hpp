// OpenSprinkler: silence the containsKey() deprecation spam (150+ call sites,
// semantics intentionally kept: containsKey() is true for explicit null values,
// which var[key].is<T>() is not). Re-apply this block when upgrading the header.
